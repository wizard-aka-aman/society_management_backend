...
namespace Society_Management_System.Migrations
{
    ...
    [Migration("20250610062620_added tables bills complaints booking notices")]
    partial class addedtablesbillscomplaintsbookingnotices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Society_Management_System.Model.Flats", b =>
                {
                    ...
                    b.Property<int>("AssignedUserIdUsersId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssignedUserIdUsersId");
            ...
            modelBuilder.Entity("Society_Management_System.Model.Bills", b =>
                {
                    b.HasOne("Society_Management_System.Model.Flats", "FlatId")
                        .WithMany()
                        .HasForeignKey("FlatIdFlatsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Society_Management_System.Model.Flats", b =>
                {
                    b.HasOne("Society_Management_System.Model.Users", "AssignedUserId")
                        .WithMany()
                        .HasForeignKey("AssignedUserIdUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
